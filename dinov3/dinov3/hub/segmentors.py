...
def _make_dinov3_m2f_segmentor(
    *,
    ...
    segmentor_weights: SegmentorWeights  = SegmentorWeights.ADE20K,
    backbone_weights: BackboneWeights  = BackboneWeights.LVD1689M,
...
def dinov3_vit7b16_ms(
    *,
    pretrained: bool = True,
    weights: SegmentorWeights = SegmentorWeights.ADE20K,
    backbone_weights: BackboneWeights = BackboneWeights.LVD1689M,
    check_hash = False,
    autocast_dtype: torch.dtype = torch.bfloat16,
    **kwargs,
